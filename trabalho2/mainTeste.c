...
{
    inicializar();
    testeInserirSemNada();// Testado ( X ), retestar com coisas do gpt depois
    testeCriarEstrutura();// Testado ( X ), retestar com coisas do gpt depois
...
void testeInserirSemNada()
{
    ...
    printf("%d - %d\n", inserirNumeroEmEstrutura(2, 2) == SEM_ESTRUTURA_AUXILIAR, inserirNumeroEmEstrutura(2, 2));
...
void testeCriarEstrutura()
{
    ...
    printf("%d - %d\n", criarEstruturaAuxiliar(2, 6) == JA_TEM_ESTRUTURA_AUXILIAR, criarEstruturaAuxiliar(2, 6));
}
/*
2 [ , , ]
*/
